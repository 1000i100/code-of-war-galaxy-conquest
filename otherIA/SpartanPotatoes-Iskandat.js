...
if(myPlanet.population >=PlanetPopulation.getMaxPopulation(myPlanet.size/2)){
result.push( new Order( myPlanet.id, getNearestPlanet(myPlanet,otherPlanets).id, myPlanet.population/3 ) );
}
